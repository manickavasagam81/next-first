...
const Slider = () => {
  ...
  return (
    <div className='flex flex-col h-[calc(100vh-6rem)] bg-fuchsia-50 md:h-[calc(100vh-9rem)] lg:flex-row'>
        <div className='flex flex-1 items-center justify-center flex-col gap-8 text-red-500 font-bold '>
            ...
            <button className='bg-red-500 text-white py-4 px-8 rounded-md text-lg'>Order Now</button>
        </div>
